...
const csvUrl =
  'https://raw.githubusercontent.com/ShotaKitazawa/ShotaKitazawa/main/certification.csv'
  ...
  return (
    <section id="certifications" className="mb-28">
      <div className="text-center">
        <h2 className="font-bold text-3xl tracking-tight">Certifications</h2>
        <div className="text-gray-400 text-xl">取得資格</div>
      </div>
